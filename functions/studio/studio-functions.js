...
function reverseCharacters(myVariableName) {
    let emptyArray = [];
    let variableArray = myVariableName.split('');
    for (let i = 0 ; i < myVariableName.length; i++) {
        emptyArray.unshift(variableArray[i]);
    }
...
function reverseCharacters(myVariableName) {
    let str = myVariableName.toString();
...
console.log(`The area is ${calculateArea(2, 4)} cm^2.`); 
console.log(`The area is ${calculateArea(14, 7)} cm^2.`); 
console.log(`The area is ${calculateArea(20)} cm^2.`);    
