...
while (fuelLevel-100*numAstronauts >=0){
  shuttleReaches = shuttleReaches + 50;
...
if (shuttleReaches >= 2000){
  console.log(`The shuttle gained an altitude of ${shuttleReaches} km. Orbit achieved!`);
}else {
  console.log(`The shuttle gained an altitude of ${shuttleReaches} km. Failed to reach orbit.`);
}